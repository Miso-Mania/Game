...
Include_Dir_JSON = -I./src/thirdparty/json-3.11.2/single_include/nlohmann
...
obj/player.o  : src/player.cpp src/player.h src/objets/obstacle.h src/playerdirection.h src/objets/pic.h
	$(cc) $(CFLAGS) $(Include_Dir_SDL2) $(Include_Dir_JSON) src/player.cpp -o obj/player.o $(LIBS)

obj/obstacle.o : src/objets/ src/objets/obstacle.h
	$(cc) $(CFLAGS) $(Include_Dir_SDL2) $(Include_Dir_JSON) src/objets/obstacle.cpp -o obj/obstacle.o $(LIBS)
...
obj/main.o : src/main.cpp src/game.h src/level.h src/player.h src/objets/obstacle.h src/playerdirection.h src/objets/pic.h
	$(cc) $(CFLAGS) $(Include_Dir_SDL2) $(Include_Dir_JSON) src/main.cpp -o obj/main.o $(LIBS)
...
obj/score.o : src/score.cpp src/score.h
	$(cc) $(CFLAGS) $(Include_Dir_SDL2) $(Include_Dir_JSON)src/score.cpp -o obj/score.o $(LIBS)

obj/pic.o : src/objets/pic.cpp src/objets/pic.h
	$(cc) $(CFLAGS) $(Include_Dir_SDL2) $(Include_Dir_JSON)src/objets/pic.cpp -o obj/pic.o $(LIBS)

obj/BoxFinish.o : src/objets/BoxFinish.cpp src/objets/BoxFinish.h
	$(cc) $(CFLAGS) $(Include_Dir_SDL2) $(Include_Dir_JSON)src/objets/BoxFinish.cpp -o obj/BoxFinish.o $(LIBS)
